...
const weeklyData = [
  {
    ...
    readings: {
      6: {
        ...
        text: [
		  { time: 0, content: '' },
          { time: 4, content: 'A Morning Routine:' },
		  { time: 5, content: 'She <b>wakes</b> up.' },
          { time: 6, content: 'She sees the moon <b>rise</b>.' },
          { time: 7, content: 'She <b>brushes</b> her <b>teeth</b>.' },
          { time: 8, content: 'Her <b>teeth</b> are <b>white</b>.' },
          { time: 9, content: 'She puts on her <b>clothes</b>.' },
          { time: 10, content: 'Her <b>shirt</b> is green.' },
          { time: 16, content: 'Her shoes are <b>yellow</b>.' },
          { time: 19, content: 'Her <b>pants</b> are <b>brown</b>.' },
