    ...
    readings: {
      6: {
        ...
        text: [
		  ...
		  { time: 4, content: 'She <b>wakes</b> up.' },
          { time: 6, content: 'She sees the moon <b>rise</b>.' },
          { time: 8, content: 'She <b>brushes</b> her <b>teeth</b>.' },
          { time: 10, content: 'Her <b>teeth</b> are <b>white</b>.' },
          { time: 12, content: 'She puts on her <b>clothes</b>.' },
          { time: 14, content: 'Her <b>shirt</b> is green.' },
          { time: 16, content: 'Her shoes are <b>yellow</b>.' },
          { time: 18, content: 'Her <b>pants</b> are <b>brown</b>.' },
          { time: 20, content: 'She goes <b>downstairs</b>.' },
          { time: 23, content: 'She gets a <b>bowl</b>.' },
          { time: 25, content: 'She <b>pours</b> milk and <b>cereal</b>.' },
          { time: 27, content: 'She eats.' },
          { time: 32, content: 'She gets the <b>newspaper</b>.' },
          { time: 35, content: 'She reads.' }
        ]
      },
      7: {
